...
<body>
    ...
    <section id="sideber" class="sideber">
        <ul class="sideber__ber">
            <h3 class="sideber__panel"><i id="left" class="fas fa-heartbeat"></i> Koushik Pharmacy</h3>
    ...
    echo " active";
        ...
        <footer class="text-center"><span>Pharmacy Management System by Koushik</span><br>©2023 All right reserved.</footer>
    </section>
    <!--------------------------------- #Sideber -------------------------------->
